...
This will run all tests in the [`./twoScoop/static/twoScoop/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open twoScoop/static/twoScoop/dist//reports/coverage/lcov-report/index.html
...
#### Source `./twoScoop/static/twoScoop/`
Main project source.

#### Actions `./twoScoop/static/twoScoop/actions/`
...
#### Components `./twoScoop/static/twoScoop/components/`
React components. Mostly __dumb__ components.

#### Constants `./twoScoop/static/twoScoop/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./twoScoop/static/twoScoop/containers/`
...
[test-dir]: /twoScoop/static/twoScoop/__tests__/
